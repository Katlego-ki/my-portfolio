const Contact = () => {
    return (
        <div className="flex-column justify-center bg opacity-90 h-[80dvh] w-9/10 md:w-3/4 mx-auto bg-black rounded-lg wrapper">
            <h1 className="border-solid border-2 border-gray-400 text-center h-fit rounded-md mx-auto text-[23px] font-mono">Contact:</h1>
            
            <div className="animate-sl w-9/10 md:w-3/4 overflow-auto pb-[10vh] m-auto wrapper">
