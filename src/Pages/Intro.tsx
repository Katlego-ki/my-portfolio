...
const Intro = () => {
  return (
    <div className='animate-sr grid h-[80vh]'>
      ...
      <div className="listA shadow-md shadow-gray-700 grid rounded-lg m-auto h-fit mb-[8vh] p-7 border-solid border-1 opacity-90 bg-black border-gray-600 mx-auto">
