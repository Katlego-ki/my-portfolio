  ...
  return (
    <>
      ...
      <div className="rounded-lg w-1/2 h-1/5 p-5 border-solid border-1 bg opacity-50 bg-black border-gray-600 mx-auto mt-10">
          <h1 className="font-mono opacity-85 text-2xl text-center">Hi, my name is Katlego Mailula, I'm interested in:</h1>
          <ul className="bg-black mt-5 w-1/2 ml-60 opacity-70 font-mono text-white">
