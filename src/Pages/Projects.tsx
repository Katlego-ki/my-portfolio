        ...
        <div className="flex-column justify-center bg opacity-50 h-[80vh] w-3/4 mx-auto bg-black rounded-lg">
            ...
            <div className="flex justify-center h-1/3">
                ...
                <a className="w-1/4 h-full m-5 " href="https://frontend-katlegobairvin-gmailcom-katlego-s-projects.vercel.app/" target="_blank" rel="noopener noreferrer" >
                    <div className="project e-learn shadow1 w-full h-full rounded-lg border-solid border-2 border-blue-900 shadow-md shadow-gray-500 bg-center bg-no-repeat bg-cover">
                ...
                <a className="w-1/4 h-full m-5 " href="https://card-memory-match.vercel.app/" target="_blank" rel="noopener noreferrer">
                    <div className="project mm-game shadow1 w-full h-full rounded-lg border-solid border-2 border-blue-900 shadow-md shadow-gray-500 bg-center bg-no-repeat bg-cover">
